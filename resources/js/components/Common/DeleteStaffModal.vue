        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <p class="modal-title" id="deleteModalLabel">Delete Staff Record</p>
                ...
                <div class="modal-footer">
                    ...
                    <button @click="deleteStaff($parent.items.id)" data-dismiss="modal" class="btn btn-primary">Delete</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            deleteStaff(item){
                var url = 'http://'+ this.serverurl +'/api/v1/staff/'+ item +'/delete-staff', method = 'delete';
                fetch(url, {
                    method: method,
                    body: JSON.stringify(),
                    headers: {
