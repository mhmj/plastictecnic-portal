                ...
                <div class="col-lg-8">
                    <div class="card card-chart">
                        <div class="card-header">
                            <h4 class="card-title text-danger">Announcement Information</h4>
                            <div class="dropdown">
                                <button v-on:click="$parent.AnnouncementView" type="button" class="btn btn-round btn-outline-default btn-simple btn-icon no-caret">
                            ...
                            <div class="row border-top" style="margin-top: 20px">
                                ...
                                <div class="col-6" style="margin-top: 5px">
                                    <div class="form-group form-group-default" style="display:flex; justify-content: flex-end">
                                        <a v-on:click="$parent.AnnouncementView" class="btn btn-default text-white">Close</a>
                                    </div>
                                </div>
                            </div>
                        </div>
