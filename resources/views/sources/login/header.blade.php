<head>
    ...
    <link href="{{ asset('vendor/css-hamburgers/hamburgers.min.css') }}" type="text/css" rel="stylesheet">
    <link href="{{ asset('vendor/animsition/css/animsition.min.css') }}" type="text/css" rel="stylesheet">
    <link href="{{ asset('vendor/select2/select2.min.css') }}" type="text/css" rel="stylesheet">
    ...
    <link href="{{ asset('fonts/Linearicons-Free-v1.0.0/icon-font.min.cs') }}" rel="stylesheet" type="text/css">
