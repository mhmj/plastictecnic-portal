...
class CreateVisitorNilaiADailyHealthTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('visitor_nilai_a_daily_health', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('visitor_nilai_a_daily_health');
    }
}
